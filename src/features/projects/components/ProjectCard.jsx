...
const ProjectCard = ({ project }) => {
    ...
    return (
        ...
        <div onClick={() => navigate(`/projects/${project.id}`)} className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-gray-200 dark:border-zinc-800 hover:border-gray-300 dark:hover:border-zinc-700 rounded-lg p-5 transition-all duration-200 group overflow-auto">
            {/* Header */}
